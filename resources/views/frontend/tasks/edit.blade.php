                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.tasks.update", [$task->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="unique_code" id="unique_code" value="{{ old('unique_code', $task->unique_code) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="due_date" id="due_date" value="{{ old('due_date', $task->due_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="call_to_action" id="call_to_action" value="{{ old('call_to_action', $task->call_to_action) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="actions_id" id="actions_id">
