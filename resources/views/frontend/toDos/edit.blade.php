                    ...
                    <form method="POST" action="{{ route("frontend.to-dos.update", [$toDo->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="completed" id="completed" value="1" {{ $toDo->completed || old('completed', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="saved" id="saved" value="1" {{ $toDo->saved || old('saved', 0) === 1 ? 'checked' : '' }}>
