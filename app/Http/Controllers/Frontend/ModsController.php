...
class ModsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.mods.index', compact('mods'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.mods.create');
    }
    ...
    public function store(StoreModRequest $request)
    {
        ...
        return redirect()->route('frontend.mods.index');
    }
    ...
    public function edit(Mod $mod)
    {
        ...
        return view('frontend.mods.edit', compact('mod'));
    }
    ...
    public function show(Mod $mod)
    {
        ...
        return view('frontend.mods.show', compact('mod'));
    }
