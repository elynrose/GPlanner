...
class SearchController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.searches.index', compact('searches'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.searches.create', compact('tasks'));
    }
    ...
    public function store(StoreSearchRequest $request)
    {
        ...
        return redirect()->route('frontend.searches.index');
    }
    ...
    public function edit(Search $search)
    {
        ...
        return view('frontend.searches.edit', compact('search', 'tasks'));
    }
    ...
    public function show(Search $search)
    {
        ...
        return view('frontend.searches.show', compact('search'));
    }
