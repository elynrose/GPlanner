...
class ReminderController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.reminders.index', compact('reminders'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.reminders.create', compact('tasks'));
    }
    ...
    public function store(StoreReminderRequest $request)
    {
        ...
        return redirect()->route('frontend.reminders.index');
    }
    ...
    public function edit(Reminder $reminder)
    {
        ...
        return view('frontend.reminders.edit', compact('reminder', 'tasks'));
    }
    ...
    public function show(Reminder $reminder)
    {
        ...
        return view('frontend.reminders.show', compact('reminder'));
    }
