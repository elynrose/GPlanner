...
class DraftController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.drafts.index', compact('drafts'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.drafts.create', compact('tasks'));
    }
    ...
    public function store(StoreDraftRequest $request)
    {
        ...
        return redirect()->route('frontend.drafts.index');
    }
    ...
    public function edit(Draft $draft)
    {
        ...
        return view('frontend.drafts.edit', compact('draft', 'tasks'));
    }
    ...
    public function show(Draft $draft)
    {
        ...
        return view('frontend.drafts.show', compact('draft'));
    }
