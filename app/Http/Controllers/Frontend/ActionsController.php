...
class ActionsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.actions.index', compact('actions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.actions.create', compact('mods'));
    }
    ...
    public function store(StoreActionRequest $request)
    {
        ...
        return redirect()->route('frontend.actions.index');
    }
    ...
    public function edit(Action $action)
    {
        ...
        return view('frontend.actions.edit', compact('action', 'mods'));
    }
    ...
    public function show(Action $action)
    {
        ...
        return view('frontend.actions.show', compact('action'));
    }
